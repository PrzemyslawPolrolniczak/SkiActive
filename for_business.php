...
<div class="for_business-site">
 ...
 <div class="question-stripe">
  ...
  <div class="detal hidden winter-detal">
    <div class="container header">
      <div class="row">
        <div class="col-xs-2 col-xs-offset-1">ATRAKCJE ZIMOWE</div>
        <div class="col-xs-1 col-xs-offset-7 exit">X</div>
      </div>
    </div>
    <div class="container content">
      <div class='row'>
         <div class="slider">
          <div><img src="<?php echo get_template_directory_uri(); ?>/img/slide1.png" alt="" class="img-responsive img-fluid slide-image"></div>
          <div><img src="<?php echo get_template_directory_uri(); ?>/img/slide2.png" alt="" class="img-responsive img-fluid slide-image"></div>
          <div><img src="<?php echo get_template_directory_uri(); ?>/img/slide3.png" alt="" class="img-responsive img-fluid slide-image"></div>
          <div><img src="<?php echo get_template_directory_uri(); ?>/img/slide4.png" alt="" class="img-responsive img-fluid slide-image"></div>
          <div><img src="<?php echo get_template_directory_uri(); ?>/img/slide5.png" alt="" class="img-responsive img-fluid slide-image"></div>
        </div>
     </div>
    </div>
  </div>
